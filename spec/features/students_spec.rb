describe "the students index page", type: :feature do
  ...
  context 'Visit students index page' do
    ...
    scenario 'when user clicks a student name they can visit their page' do
      student = build(:student)
      student.save
      visit students_path
      link = page.first(:css, 'td a')
      link.click
      expect(page.current_path).to eq student_path(student)
    end
  end

  context 'Visit student show page' do
